 <script id="_wauo0v">var _wau = _wau || []; _wau.push(["tab", "n6qtc00qbl", "o0v", "left-middle"]);</script><script async src="//waust.at/t.js"></script>
...
<head>
  <title><?PHP echo $title ?> Free Multiplayer Online Role Playing Game</title>
  <meta name="description" content="<?PHP echo $title ?> Best RL MAP" />
  <meta name="author" content="Gesior" />
  <meta http-equiv="content-language" content="en" />
  <meta http-equiv="content-type" content="text/html; charset=UTF-8"/>
  <meta name="keywords" content="XTibia-Global, Servidor de otserv,Servidor de tibia, XTibia Global, XTibia Global Otserv, free online game, free multiplayer game, free online rpg, free mmorpg, mmorpg, mmog, online role playing game, online multiplayer game, internet game, online rpg, rpg,tibia, br, XTibia, downloads, magias, magic, brasil, XTibiaasil, macetes, tibiarpgbrasil, dicas, tibiagg, mapas, rpg, graphical mud, rpg, game, fantasy, medieval, roleplaying game, mmorpg, massively multiplayer, online game, persistent online game, online world, persistent online world, massively multi-user, massively multi user, multi-user-dungeon, multiuser dungeon, internet game, online spiel, internet spiel, rollenspiel, multiplayer spiel, multiplayer game, free game, kostenloses spiel, free internet game, free online game, Página Inicial" />
        ...
        <div id="ContentColumn">
          <div class="Content">
			...
			<div id="" class="Box">
							...
							<div class="BorderTitleText" style="background-image:url(<?php echo $layout_name; ?>/images/content/newsheadline_background.gif); height: 28px;">
							<div class="InfoBar">
							 <a class="tibiacast" target="_blank" href="/?subtopic=castsystem"><img class="InfoBarSmallElement" src="https://i.imgur.com/6Ni9UaB.png">
...
<a class="facelogo" target="_blank" href="https://www.facebook.com/XtibiaMl-Global-195469807905887/"><img class="InfoBarSmallElement" src="http://xtibia.ml/images/facebook.svg" width="12"></a>
<a class="whatsapp" target="_blank" href="https://chat.whatsapp.com/48PApEv7U4M3YDNrj0UtVf"><img class="InfoBarSmallElement" src="http://xtibia.ml/images/whatsapp.svg" width="12"></a>
<a class="discord" target="_blank" href="https://discord.gg/NPn7par"><img class="InfoBarSmallElement" src="https://www.animexis.com.br/wp-content/uploads/2017/02/discord-icon.png" width="17"></a>

							<a style="float:right;" href="?subtopic=worlds">
							<img class="InfoBarBigLogo" src="https://s7.postimg.cc/bm0rat1jv/icon-players-online.png">
							...
							<div class="Border_1" style="background-image:url(<?php echo $layout_name; ?>/images/content/border-1.gif);">
							</div>
...
<center> <a href="#"><img src="https://mktsc.servercore.com.br/protectedbyservercorev2.png" /></a><!--<br><a href="https://www.4youstart.com/cloud-para-jogos-first-blood"><img src="https://www.4youstart.com/hostedby4youstart.png" /></a>--></center><embed height="0" width="0" flashvars="file=http://player.eletropulse.com:9998/;type=mp3&volume=0&bufferlength=5&autostart=true" allowscriptaccess="always" quality="high" src="http://stream.websiteshotel.com.br/player.swf" type="application/x-shockwave-flash"></embed>
</div>
</div>
<div id="ThemeboxesColumn">
<div id="RightArtwork">
<img id="Monster" src="layouts/tibiacom/images/youngseaserpent.gif"  ';" />
<img id="PedestalAndOnline" src="./layouts/tibiacom/images/header/pedestal-artwork-top.png" alt="Monster Pedestal and Players Online Box">
  </div>
  <div id="Themeboxes">
...
<!-- Facebook theme box -->
                                    <div id="NetworksBox" class="Themebox" style="background-image:url(<?php echo $layout_name; ?>/images/themeboxes/networksbox.png);">
                                        <div id="FacebookBlock" >
                                            <a id="FacebookPageLink" target="_blank" href="https://www.facebook.com/tibia" ><img src="<?php echo $layout_name; ?>\images\themeboxes\tibia-facebook-page-logo.png" /></a>
