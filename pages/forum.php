...
$sections = array(1 => 'Noticias / News', 2 => 'Updates Logs', 3 => 'Quests', 4 => 'Dicas / Sugestions', 5 => 'Bug Report', 6 => 'Duvidas / Help', 7 => 'Donate');
$sections_desc = array(1 => 'Noticias da pagina inicial.', 2 => 'Veja nossos updates.', 3 => 'Fale sobre quests.', 4 => 'Coloque aqui dicas pra o servidor e para a equipe.', 5 => 'Reporte problemas aqui.', 6 => 'Está com duvidas este é o local', 7 => 'Neste local iremos informa tudo que é feito com as doações.');
...
if($action == 'show_thread')
{
    ...
    if(!empty($thread_name['name']))
    {
        ...
        foreach($threads as $thread)
        {
            ...
            if($thread['group_id'] >= 3)
                $main_content .= '
									<img class="CipPostIcon" src="'.$layout_name.'/images/global/forum/person-man.png" /><br>';
									
            if($thread['group_id'] <= 1)
                $main_content .= '
									<img class="CipPostIcon" src="'.$layout_name.'/images/global/forum/user-5.png" /><br>';
