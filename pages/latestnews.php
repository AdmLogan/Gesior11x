...
<div id="LayerPop2" align="center" style="position: absolute; top:-520px; margin:auto; padding:auto; width: 100%; z-index: 5000;"><a href="?subtopic=buypoints" target="_BLANK"><img src="https://s31.postimg.org/a9xgllo4r/tibianoxbanner.png" class="imgBorder"></a><BR /><input type="button" name="fechar" value="FECHAR" onclick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'" style="font-family: Verdana; font-weight: bold; font-size:10px;  color: #FFFFFF; background-color: #000000; border: 1px solid #fffff;"></div>
-->
<!-- <td><img src="./layouts/tibiacom/images/blank.gif" width=10 height=1 border=0 alt='' /></td>
</tr></table><div id="LayerPop" style="display:block; position:absolute; left:0px; top:-800px;"></div>
<div id="LayerPop2" align="center" style="position: absolute; left:-10px; top:-640px; margin:auto; padding:auto; width: 100%; z-index: 5000;"><a href="?subtopic=buypoints" target="_BLANK"><img src="https://s18.postimg.cc/lnjj6axi1/c749c125-99e9-4c4b-9471-559d4e3d4726.jpg" class="imgBorder"></a><BR /><input type="button" name="fechar" value="CLOSE" 
onclick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'" style="font-family: Verdana; font-weight: bold; font-size:18px;  color: #ffffff; background-color: #151b1d; border: 1px solid #fffff;"></div>
-->
    ...
    <div class="Border_2">
        <div class="Border_3">
            <div class="BoxContent" style="background-image:url('.$layout_name.'/images/content/scroll.gif);">
				 ...
				 </b></font></center><br></b><font size="2px"> <center> <b> ➮ IP:</b> xtibia.ml <b>➮ Port:</b> 7171 <b>➮ Version: </b>10 <b>➮ Client: </b> <a href="?subtopic=downloads">Download</a> </center> <p> 
				 <div id=\'TeaserThumbnail\'><img src="layouts/tibiacom/images/news/featuredthumb_4615.jpg" width=145 height=75 border=1 alt="" ALIGN=right hspace="0" /></div>
                <div id=\'TeaserText\'>
                    <div style="position: relative; top: -2px; margin-bottom: 10px;"></br>
					
				 <pre>
</pre> </b></font></center><br></b><font size="2px">Bem vindo ao <b><font color="green">XTibia</font></b>, somos o melhor Global RL Map, o mais completo hoje,


 Features: <b>Ping perfeito HOST BR</b>, <b>Sem missão para acessos</b>, <b>Novas areas de hunt e melhoradas</b>, <b>todas as Quests funcionando</b>, <b>Cooldown das magias balanceadas</b>, <b>Sistemas Exclusivos</b>, <b>Eventos Automaticos</b>, <b>Um novo NPC de Task proprio</b> e muito mais. Temos uma Staff dedicada em correção e melhoria de problemas diarios. <b>O servidor foi inaugurado dia 27/06/2018</b>, nossa alegria é garantir e proporcionar a todos vocês um servidor único e especial.<br>
<!-- <br><center><a href="?subtopic=buypoints"><img src="https://s7.postimg.cc/y0os5if6z/banner3.jpg" width=690 height=80 /></a><center></font>
</td></tr><tr><td>
-->
<!-- <center> <iframe src="http://free.timeanddate.com/countdown/i6ao0o89/n233/cf12/cm0/cu4/ct0/cs1/ca0/co0/cr0/ss0/cac000/cpc000/pct/tcfff/fs100/szw1000/szh421/iso2018-06-27T10:00:00" allowTransparency="true" frameborder="0" width="339" height="90"></iframe>  </center> -->
<br><center><b> <a href="?subtopic=createaccount"><b>Crie sua Account</b></a> | <a href="?subtopic=team"><b>Suporte Team</b></a></center></b>	
                </font> </div>
	 </div>
            </div>
        </div>
