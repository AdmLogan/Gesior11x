...
$sections = array(
					...
					7 => 'Sugestões');
$sections_desc = array(
					1 => 'Aqui estão as últimas notícias do servidor, e você pode comentar.', 
					2 => 'Sinta-se livre para dizer o que você pensa sobre seu inimigo.', 
					3 => 'Fale com outros sobre quests que você fez e como fazê-las.', 
					4 => 'Esclareça tudo sobre doação no servidor, saiba todos os benefícios de ser um colaborador!', 
					5 => 'Informe erros no site e no jogo aqui.', 
					6 => 'Esta opção é sobre eventos. Aqui você pode anunciar seus eventos em todo o servidor para encontrar mais participantes ou trocar ideias sobre como organizar melhor os eventos.', 
					7 => 'Aqui você pode opinar sobre o servidor.');
// END
...
if($action == '')
{
    ...
    $main_content .= '
		<table border=0 cellpadding=3 cellspacing=1 width=100%>
			<tr>
				...
				<td  bgcolor="#505050" class="ff_white" colspan=1 align="center" ><b>Last Post</b></td>
			</tr>';
    ...
    foreach($sections as $id => $section)
    {
        ...
        $main_content .= '
			<tr bgcolor="'.$bgcolor.'">
				<td  bgcolor="#D4C0A1" class="ff_std" >&nbsp;</td>
				<td bgcolor="#D4C0A1" class="ff_std"><a href="?subtopic=forum&action=show_board&id='.$id.'">'.$section.'</a><br /><small>'.$sections_desc[$id].'</small></td>
				<td bgcolor="#F1E0C6" class="ff_std" colspan=1 align="center">'.(int) $counters[$id]['posts'].'</td>
				<td bgcolor="#D4C0A1" class="ff_std" colspan=1 align="center">'.(int) $counters[$id]['threads'].'</td>
				<td bgcolor="#F1E0C6" class="ff_std" align="left" NOWRAP>';
				...
				<tr>
					<td  bgcolor="#D4C0A1" class="ff_std" colspan=1 align="center" >
						<div class="HNCContainer" >
							...
							$main_content .= $layout_name.'/images/general/blank.gif"';							
						$main_content .= '	
	...
	<center>
		<table border=0 cellpadding=3 cellspacing=0>
			<tr>
				...
				<td  class="ff_info" colspan=1 align="center" valign="middle" NOWRAP ><img src="'.$layout_name.'/images/forum/logo_hot.gif" border=0 width=22 height=22><img src="'.$layout_name.'/images/forum/logo_hotnew.gif" border=0 width=22 height=22></td>
