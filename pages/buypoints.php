...
<h5>O Doador está ciente que a doação não pode ser devolvida.</h5>
...
-<b>PAGAMENTOS VIA PAYPAL</b>
Todos pagamentos via paypal, não estao 100% automaticos ainda, voce deverá chamar um membro da staff no game ow enviando um e-mail para zoin10k@gmail.com, Com seu nome e quantos reais foram doados!!! Obrigado
...
if ($config['site']['paypal'] == 1){
		...
		$main_content .='
		<TR BGCOLOR=#D4C0A1>
			<TD><input type="radio" name="method" value="3" />&nbsp;CAIXA ECONOMICA - <b>Depósitos/DOCS/Transferencias Bancárias</b></TD>
		</TR>';}
		...
		$main_content .='
		<TR BGCOLOR=#D4C0A1>
			<TD><input type="radio" name="method" value="4" />&nbsp;Picpay - <b>Cartões de crédito</b></TD>
		</TR>';}
...
<option value="1000">R$:10,00 = 10 Tibia Coin</option>
<option value="2000">R$:20,00 = 20 Tibia Coin</option>
<option value="3000">R$:30,00 = 30 Tibia Coin</option>
<option value="4000">R$:40,00 = 40 Tibia Coin</option>
<option value="5000">R$:50,00 = 50 Tibia Coin</option>
<option value="6000">R$:60,00 = 60 Tibia Coin</option>
<option value="7000">R$:70,00 = 70 Tibia Coin</option>
<option value="8000">R$:80,00 = 80 Tibia Coin</option>
<option value="9000">R$:90,00 = 90 Tibia Coin</option>
<option value="10000">R$:100,00 = 100 Tibia Coin</option>
...
<p style="text-align: center;">Descrição: Envie o seu account name/nome personagem no pagamento</p> 
...
<span class="CaptionBorderTop" style="background-image: url('.$layout_name.'/images/content/table-headline-border.gif);"></span> 
<span class="CaptionVerticalLeft" style="background-image: url('.$layout_name.'/images/content/box-frame-vertical.gif);"></span> 
<div class="Text">Banco Santande</div> 
<span class="CaptionVerticalRight" style="background-image: url('.$layout_name.'/images/content/box-frame-vertical.gif);"></span>
<span class="CaptionBorderBottom" style="background-image: url('.$layout_name.'/images/content/table-headline-border.gif);"></span> 
<span class="CaptionEdgeLeftBottom" style="background-image: url('.$layout_name.'/images/content/box-frame-edge.gif);"></span> 
<span class="CaptionEdgeRightBottom" style="background-image: url('.$layout_name.'/images/content/box-frame-edge.gif);"></span> 
...
<li> 30 BRL (for 30 points)</li>
<li> 40 BRL (for 40 points)</li>
<li> 50 BRL (for 50 points)</li>
<li> 60 BRL (for 60 points)</li>
<li> 70 BRL (for 70 points)</li>
<li> 80 BRL (for 80 points)</li>
<li> 90 BRL (for 90 points)</li>
