...
$sections = array(1 => 'Noticias', 2 => 'Updates Logs', 3 => 'Quests', 4 => 'Dicas', 5 => 'Bug Report', 6 => 'Duvidas', 7 => 'Doações');
$sections_desc = array(1 => 'Noticias da pagina inicial.', 2 => 'Veja nossos updates.', 3 => 'Fale sobre quests.', 4 => 'Coloque aqui dicas pra o servidor e para a equipe!', 5 => 'Report bugs aqui.', 6 => 'Está com duvidas este é o local', 7 => 'Neste local iremos informa tudo que é feito com as doações.');
    ...
    if(!empty($thread_name['name']))
    {
        ...
        foreach($threads as $thread)
        {
            ...
            if($thread['group_id'] <= 1)
                $main_content .= '
									<img class="CipPostIcon" src="https://www.tibiawiki.com.br/images/6/67/Icone10.png"/><br>';
